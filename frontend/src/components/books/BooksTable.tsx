            ...
            <table className="w-full text-sm">
                <thead>
                    <tr className="border-b border-gray-100 bg-gray-50/60">
                        ...
                        <th className="text-left text-xs font-semibold text-gray-400 px-4 py-3">Author</th>
                        <th className="text-left text-xs font-semibold text-gray-400 px-4 py-3">Category</th>
                        <th className="text-left text-xs font-semibold text-gray-400 px-4 py-3">ISBN</th>
                        ...
                        <th className="text-left text-xs font-semibold text-gray-400 px-4 py-3">Added On</th>
