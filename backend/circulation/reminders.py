...
Library Management System"""
    ...
    return f"{sent_count} reminder(s) sent, {skipped_count} skipped (sent within 24h)."
...
If the book is not returned immediately, your library account may be restricted.
